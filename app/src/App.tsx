...
function App(props: AppPropsType) {
  return (
    <>
      ...
      <Text
        className="foo baz"
        data-ecu="ywCnxnrCp9f:2">
        {'1\n2\n3\n4'}
      </Text>
      <Text data-ecu="ywCnxnrCp9f:3">Foo!</Text>
      <ComponentWithAVeryLongNameSoLongSoLongSoLongSoLong // ecu-display-name LongLongLongLongLongLongLongLong
      />
      <Text
        className="responsive-flex"
        data-ecu="ywCnxnrCp9f:4">
        Responsive
      </Text>
      <CoolDiv />
      <Text data-ecu="ywCnxnrCp9f:5">Then double click here!</Text>
      <DualCoolDivs />
    </>
  )
}
