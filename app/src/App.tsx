  ...
  return (
    <>
      <Div // ecu-display-name Container
        data-ecu="lLWpTAZvm_:0">
        <Text // ecu-display-name Text!
          data-ecu="lLWpTAZvm_:0_0">
          {':D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D :D  '}
        </Text>
      </Div>
      <Text
        className="red margin-x"
        data-ecu="lLWpTAZvm_:1">
        Red className
      </Text>
      ...
      <Text
        className="foo baz"
        data-ecu="lLWpTAZvm_:2">
        {'1\n2\n3\n4'}
      </Text>
      <Text data-ecu="lLWpTAZvm_:3">Foo!</Text>
      <ComponentWithAVeryLongNameSoLongSoLongSoLongSoLong // ecu-display-name Long
      />
      <Text data-ecu="lLWpTAZvm_:4">First double click here</Text>
      <CoolDiv />
      <Text data-ecu="lLWpTAZvm_:5">Then double click here!</Text>
      <DualCoolDivs />
    </>
  )
}
